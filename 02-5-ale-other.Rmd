...
As expected the ALE estimations with grid size 20 and 30 are not sensitive to the effect, as only 2 datapoints fall to the interval $[4.9, ~5.1]$. Increasing the grid size ensures that some interval boundaries fall into the interval $[4.9, ~5.1]$ which exposes the step of the prediction function.
