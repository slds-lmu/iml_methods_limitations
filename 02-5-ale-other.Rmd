...
This is also shown by the following grafic, which shows the delta of the maximum and the minimum of 100 ALE estimations (on different data samples) with grid size 10, 25 and 50. The expected higher variance of the estimations with higher grid sizes have especially strong effects in the region from $x_1 = 7$ to $x_1 = 10$.  
