...
```{r echo=FALSE, out.width='80%', fig.cap="The PDP shows that young children had the highest survival probability, which is sharply dropping until age 18. For older passengers, the decline in survival probability is still evident as age goes up, but less pronounced."}
...
```{r echo=FALSE, out.width='80%', fig.cap="The classification PDP reveals that passengers in lower classes had a lower probability to survive than those in a higher class."}
...
```{r echo=FALSE, out.width='80%', fig.cap="The two-dimensional PDP for the numerical feature Age and the categorical feature Sex shows that the survival probability for female passengers strongly differs from male passeners. While for both genders the probability declines as age increases, this decrease is much steeper for males."}
knitr::include_graphics('images/pdp_2_features_1.jpeg')
```

```{r echo=FALSE, out.width='80%', fig.cap="The two-dimensional PDP for the numerical features Age and Fare illustrates that the age range 0-20 has a fairly uniform probability to survive, independent of the fare paid. From age 20 onwards, however, passengers travelling at a lower fare also had a much lower survival probability than those that paid a high fare."}
