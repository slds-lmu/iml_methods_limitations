...
..
More formally we can show that for the underlying data for the graph a kernel width of X results in the surrogate model featuring a coefficient of X (on average) which seems accurate within the locality. 
...
The third one features inteaction terms.
...
x1 <- rnorm(100, 10, 3)
x2 <- rnorm(100, 5, 4) + 0.1 * rnorm(100, x1, x1)
