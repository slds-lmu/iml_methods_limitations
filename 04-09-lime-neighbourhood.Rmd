...
This problem is heavily associated with the sampling strategy (and the fact that we work with numerical data).
This will be dealt with in more depth in the next chapter.
...
For details on the data set please refer to @molnar2018 (https://christophm.github.io/interpretable-ml-book/bike-data.html).
...
Using this data we aim to use a random forest to predict the number of daily bycicle hires.
