...
Then, either the windspeed (all observations except number 3) or the season (observation 3) is selected as global feature.
...
For other observations, such as observations 3 and 4, we may argue that there local somewhat stable local explanations.
...
The reasons for this varying behaviour can be manifold.
...
Considering our explanations, the sparse explanations were highly correlated consisting of similar features.
