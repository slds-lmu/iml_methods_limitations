...
We observe that the predictions of the random forest look very accurate in figure \@ref(fig:fig3)
...
Leaving the controlled environment we may face more challenges than we used to working with simulated data.
...
This figure would help us to clearly identify a local model.
