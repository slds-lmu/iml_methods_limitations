...
```{r, fig3, eval = TRUE, echo = FALSE, fig.align = 'center', out.width = '99%', fig.cap = "Simulated data: Random forest predictions for non-linear univariate relationship."}
...
Figure \@ref(fig:fig131) displays ideal stability paths with the three distinct ares observed earlier:
