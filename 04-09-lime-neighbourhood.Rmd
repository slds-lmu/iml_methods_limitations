...
```{r, fig1, eval = TRUE, echo = FALSE, fig.align = 'center', out.width = '99%', fig.cap = "In( appropriate) kernel widths for kernel density estimations."}
...
```{r, fig3, eval = TRUE, echo = FALSE, fig.align = 'center', out.width = '99%', fig.cap = "Simulated data: Random forest predictions for non-linear univariate relationship. The solid line resembles the predictive surface."}
...
knitr::include_graphics("images/04-09-14optimal.png")
```
