...
For the rest of the Chapter we will assume certain data generating mechanisms. This allows us to compute the true effect of interventions with the help of Pearl's do-calculus [@pearl1993]. In the structural equation model this is equivalent to removing all incoming dependencies for the intervened variable and fixing a specified value. As an effect, the distributions of variables that are caused by the intervened variable may change as well.
