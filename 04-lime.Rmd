...
First, why and how do we perturb?
...
Furthermore, different types of data can be used as an original set. 
...
However, typically numerical data is perturbed by simulating marginal normal distrubutions or binning the numerical features in categorical/ordinal ones.
One can easily see that this way the full grid is not likely to be explored as fully as for categorical features.
In fact, the way numerical features are handled by LIME is one of the main limitations of the approach.
However, this limitation will not be discussed in detail in this book.
Moreover, perturbation of the data itself is very critical to LIME and may be subject to criticism.
...
This leads us to the second open question:
...
Having discussed the first two open questions - why and how we perturb the data and what neighbourhood refers to - we can focus on the third question:
...
Putting the fidelity and complexity term together and minimising them gives us a trade-off solution between best local fit and best interpretability. 
