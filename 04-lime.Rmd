...
Hence, LIME aims to get a more complete \emph{grid} of the data in order to get a better idea on what-if scenarios.
...
Thus, LIME perturbs the original data and uses the perturbed data set instead.
