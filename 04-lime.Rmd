...
Weighting the observations w.r.t. their proximity to the observation being explained seems like a good idea, possibly implemented as a kernel.
...
Otherwise the explainer may be ill-located in space having nothing in common with the original problem anymore.
