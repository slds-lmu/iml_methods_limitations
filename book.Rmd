...
Note that for our previous examples this was not necessary as all of our features were of the same cardinality.
...
We do so because this data set is familiar to most machine learning scholars and it only features numeric data (We found some issues with the R implementation for mixed data.).
...
>>>>>>> 32b2046896b35e7903ff2d49f56e47fd93900322
...
feature_growth <- function(
  ...
  outer_return = lapply(
    ...
    function(p) {
      ...
      explainer = lime(train_data[1L:p], black_box, bin_continuous = FALSE, 
                       use_density = FALSE)
