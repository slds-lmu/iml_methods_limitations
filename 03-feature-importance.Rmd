...
```{r,out.width="65%", echo = FALSE, message = FALSE, fig.align='center'}
knitr::include_graphics("images/Permutation_1.jpg")
```
...
```{r,out.width="65%",echo = FALSE, message = FALSE, fig.align='center'}
knitr::include_graphics("images/Permutation_2.jpg")
```

<center>
$PFI_{p} = L(y,f(X_{\text{perm,p}}))- L(y,f(X))$</center>
...
```{r,out.width="65%", fig.align='center',echo = FALSE, message = FALSE}
