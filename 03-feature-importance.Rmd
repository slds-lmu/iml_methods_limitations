...
```{r LOCO,out.width="65%", fig.align='center',echo = FALSE, message = FALSE,fig.cap="Example for Leave-One-Covariate-Out Feature Importance. The tables illustrate the second step of the algorithm of LOCO in particular the drop of the first and p-th feature. The dark grey columns of the original data set mark the variables that will be dropped in the next step of the calculation. This step is made to break the relationship between the interested feature and the target value. Based on the formular underneath the tables the FI of LOCO is calculated."}
