...
```{r,out.width='25%', fig.align='center', echo = FALSE, message = FALSE}
knitr::include_graphics("images/Permutation_0.jpg")
```
...
## Wie viele Wiederholungen fÃÂÃÂ¼r Konfidenzintervall?
n.conf <- 100
