...
```{r, eval = FALSE, echo = TRUE, fig.align = 'center', fig.cap = "LIME implementation"}
...
```{r, eval = TRUE, echo = FALSE, fig.align = 'center', fig.cap = "LIME output"}
...
nice_plot = function(means, sds, headline, color1 = rgb(135/255, 150/255, 40/255), color2 = rgb(70/255, 95/255, 25/255), xlab = "Feature", ylab = "Weight") {
...
png(filename, width = 700, height = 500)
nice_plot(means_scaled, sds_scaled, "LIME", ylab = "Weight / weight")
dev.off()
...
```{r, eval = TRUE, echo = FALSE, fig.align = 'center', fig.cap = "Overview of each numerical feature compared to target 'medv' in the boston housing dataset"}
...
```{r, eval = FALSE, echo = TRUE, fig.align = 'center', fig.cap = "LIME output", warning=FALSE}
