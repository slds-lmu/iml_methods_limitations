...
```{r, figbasic, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "Visulization of LIME applied on a non-linear function - the right plot uses the same settings but is resampled", warning=FALSE}
...
```{r, figbad, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "LIME applied on a non-convex function - again, the right plot uses the same settings but is resampled", warning=FALSE}
...
```{r, figgood, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "LIME applied twice on a non-convex function with increased sample size but different sample seed", warning=FALSE}
...
```{r, figkernel, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "LIME applied on a non-convex function with increased kernel width and two different sample seeds in each plot", warning=FALSE}
...
```{r, figboston, eval = TRUE, echo = FALSE, fig.align = 'center', fig.cap = "Overview of the normalized numerical features compared to the target 'medv' in the Boston Housing dataset"}
...
```{r, figbostmeanoutlier, eval = TRUE, echo = FALSE, out.width = '99%', fig.show='hold', fig.align = 'center', fig.cap = "Weight coefficients of LIME applied to the mean data point in the left plot and an extreme outlier on the right plot -- errorbars indicating the empirical 95\\% confidence interval across repeated runs"}
...
```{r, figbosttreelm, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "LIME weights of a decision tree as black-box model versus a linear regression model"}
...
```{r, figbostkdebin, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "LIME weights of the mean data point with kernel density estimation as sampling strategy versus binning"}
...
```{r, figbike, eval = TRUE, echo = FALSE, fig.align = 'center', fig.cap = "Overview of the categorical features compared to the target 'cnt' in the Rental Bikes dataset"}
...
```{r, figmajorminor, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "Weight coefficients of LIME applied to the majority data point versus the minority data point"}
...
```{r, figbiketreelm, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "LIME weights of a decision tree as black-box model versus a linear regression model"}
...
```{r, figsdp, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "Average standard deviation of the resulting LIME weights regarding the feature dimension of the Boston Housing and Rental Bikes dataset. Each line shows a different sampling option."}
...
```{r, figsdnfeat, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "Average standard deviation with the same settings as before but with full feature size. The x-axis plots the number of features selected for the explainer."}
...
```{r, fignperm, eval = TRUE, echo = FALSE, fig.align = 'center', fig.cap = "Average standard deviation with the same settings as before but increasing sample size. A clear trend can be seen here: Increasing the amount of samples (which is acting as train data for our surrogate model) has remarkable influence on weight stability."}
...
```{r, figverybad, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "LIME trying to explain an extremely volatily prediction surface. The prediction surface is an extreme overfit of a small subset of the Boston Housing data."}
...
```{r, figsmooth, eval = TRUE, echo = FALSE, fig.align = 'center', fig.cap = "Average standard deviation of the same settings as before versus the black-box model smoothness. As the black-box model class, a random forest was used with increasing parameters per iteration. The last tick in this graph is corresponding to a random forest with 91 trees and a minimum node size of 10."}
...
```{r, figoverfit, eval = TRUE, echo = FALSE, fig.align = 'center', fig.cap = "Average standard deviation with the same settings as before versus the tree amount of the XGBoost model used as black-box predictor."}
