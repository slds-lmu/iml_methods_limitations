...
```{r, figbostmeanoutlier, eval = TRUE, echo = FALSE, fig.show='hold', fig.align = 'center', fig.cap = "Weight coefficients of LIME applied to the mean data point in the left plot and an extreme outlier on the right plot -- errorbars indicating the empirical 95% confidence interval across repeated runs"}
