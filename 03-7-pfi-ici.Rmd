...
In the subchapter \@ref(ch31), it will be focussed on to what extent the PI and ICI plots can uncover interaction effects between features. To give this a new angle of perspective, a new method, called "derivative-ICI" (see \@ref(ch312)) will be introduced. 
