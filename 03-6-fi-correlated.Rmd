...
The features inside the sine function are ranked not as important as the linear one (see $X_3$ vs. $X_4$), but with high correlation the feature with sine function gets ranked higher (see $X_1$)
