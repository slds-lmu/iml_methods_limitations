...
```{r Simulation02, message = FALSE, eval = FALSE ,fig.height=6, fig.width=12, fig.cap="Simulation of correlated features 1 and 2 (r=0.25) "}
...
```{r Simulation03, message = FALSE, eval = FALSE ,fig.height=6, fig.width=12, fig.cap="Simulation of medium correlated features 1 and 2 (r=0.5) "}
...
```{r Simulation04, message = FALSE, eval = FALSE ,fig.height=6, fig.width=12, fig.cap="Simulation of high correlated features 1 and 2 (r=0.75) "}
...
```{r Simulation05, message = FALSE, eval = FALSE ,fig.height=6, fig.width=12, fig.cap="Simulation of complete correlated features 1 and 2 (r=0.99) "}
