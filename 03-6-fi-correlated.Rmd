...
* Simulation of different kind of szenarios:
  + Strength of correlation: complete correlation r = 0.99 (complete correlation); r = 0.75; r = 0.5; r = 0.25; r = 0 (no correlation)
...
Here we want to investigate the effect on PFI and LOCO Feature Importance of the correlated features with different kind of dependencies on the target value y. (only the scenarios which show interesting results will be shown later)
...
#Plot:
prf <- ggplot(imp.datrfu, aes(x=reorder(feature, importance), ymin=importance.05, ymax=importance.95)) +
    geom_point(mapping=aes(x=feature, y=importance), size=3, shape=21, fill="white") +
    geom_point(mapping=aes(x=imp.datrfc25$feature, y=imp.datrfc25$importance), size=3, shape=21, fill="lightblue",color = "lightblue") +
    geom_point(mapping=aes(x=imp.datrfc5$feature, y=imp.datrfc5$importance), size=3, shape=21, fill="blue") +
    geom_point(mapping=aes(x=imp.datrfc75$feature, y=imp.datrfc75$importance), size=3, shape=21, fill="darkblue") +
    geom_point(mapping=aes(x=imp.datrfc$feature, y=imp.datrfc$importance), size=3, shape=21, fill="black") +
    coord_flip() +
...
#Plot:
plm <- ggplot(imp.datlmu, aes(x=reorder(feature, importance), ymin=importance.05, ymax=importance.95)) +
    geom_point(mapping=aes(x=feature, y=importance), size=3, shape=21, fill="white") +
    geom_point(mapping=aes(x=imp.datlmc25$feature, y=imp.datlmc25$importance), size=3, shape=21, fill="lightblue") +
    geom_point(mapping=aes(x=imp.datlmc5$feature, y=imp.datlmc5$importance), size=3, shape=21, fill="blue") +
    geom_point(mapping=aes(x=imp.datlmc75$feature, y=imp.datlmc75$importance), size=3, shape=21, fill="darkblue") +
    geom_point(mapping=aes(x=imp.datlmc$feature, y=imp.datlmc$importance), size=3, shape=21, fill="black") +
    coord_flip() +
    theme(plot.subtitle = element_text(size = 10)) +
    labs(y = "Feature Importance MSE", x= "") + 
...
#Plot:
ploco <- ggplot(data = FIPu ,aes(x=featureu,y = importance_u)) + #### hier fehler 
  geom_point(mapping=aes(x=featureu, y=importance_u), size=3, shape=21, fill="white") +
  geom_point(mapping=aes(x=FIPc25$featurec25, y=FIPc25$importance_c25), size=3, shape=21, fill="lightblue") +
  geom_point(mapping=aes(x=FIPc5$featurec5, y=FIPc5$importance_c5), size=3, shape=21, fill="blue") +
  geom_point(mapping=aes(x=FIPc75$featurec75, y=FIPc75$importance_c75), size=3, shape=21, fill="darkblue") +
  geom_point(mapping=aes(x=FIPc$featurec, y=FIPc$importance_c), size=3, shape=21, fill="black") +
  coord_flip() +
  theme(plot.subtitle = element_text(size = 10)) +
...
prf <- ggplot(imp.datrfu, aes(x=reorder(feature, importance), ymin=importance.05, ymax=importance.95)) +
    geom_point(mapping=aes(x=imp.datrfu$feature, y=imp.datrfu$importance), size=3, shape=21, fill="white") +
    geom_point(mapping=aes(x=imp.datrfc25$feature, y=imp.datrfc25$importance), size=3, shape=21, fill="lightblue",color = "lightblue") +
    geom_point(mapping=aes(x=imp.datrfc5$feature, y=imp.datrfc5$importance), size=3, shape=21, fill="blue") +
    geom_point(mapping=aes(x=imp.datrfc75$feature, y=imp.datrfc75$importance), size=3, shape=21, fill="darkblue") +
    geom_point(mapping=aes(x=imp.datrfc$feature, y=imp.datrfc$importance), size=3, shape=21, fill="black") +
...
du <- data_sim5
du["y1sim5"] <- y1u
tasku = makeRegrTask(data = du , target= "y1sim5")
learneru = makeLearner("regr.randomForest")
featu = getTaskFeatureNames(tasku)
featu
mod.fullu = train(learneru, tasku)
