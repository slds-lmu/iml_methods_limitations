...
```{r bmr01, echo=FALSE, out.width="100%", fig.cap="Benchmark results of scenario 1 for data sets with p = 0, p = 0.5 and p = 0.99 (from left to right). On top the performance measure is the MSE, at the bottom $R^2$. The color represents the learning algorithm. Red: Random Forest, green: SVM and blue: Linear Model."}
...
prferr <- ggplot(data = drfPFI, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) + 
  ...
  coord_flip() +
  scale_color_manual(values = c("0" = "skyblue", "0.25" = "royalblue", "0.5" = "blue",
...
prfrank01 <- ggplot(drfPFI, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
                               "X3" = "#006600", "X4" = "#33CC33"))+
  scale_x_reverse()+
...
exp <- plotLearnerPrediction(rf_learner, extrapolation_task)+
        ...
        geom_point(aes(x = 2.5, y = -2), color = "blue")+
...
psvmerr <- ggplot(data = dsvmPFI, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp))+
  geom_point(fill = "white",size = 0, shape = 21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
psvmrank01 <- ggplot(dsvmPFI, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
plmerr <- ggplot(data = dlmPFI, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) + 
  geom_point(fill = "white",size = 0, shape = 21 , 
             stroke= 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
plmrank01 <- ggplot(dlmPFI, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
plocoerr <- ggplot(drfLOCO, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp))+ 
  geom_point(fill = "white", size = 0, shape = 21 , 
             stroke= 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
plocorank01 <- ggplot(drfLOCO, aes(x = averagerank , y = Corr, color = features, group = features))+
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
plocosvmerr <- ggplot(dsvmLOCO, aes(x = features, y = importance, color = Corr, ymin= minimp, ymax=maximp)) +      geom_point(fill = "white", size = 0, shape = 21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
  scale_color_manual(values=c("0" = "skyblue", "0.25" = "royalblue", "0.5" = "blue",
...
plocorank02 <- ggplot(dsvmLOCO, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
plocolmerr <- ggplot(dlmLOCO, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) +
  geom_point(fill = "white", size = 0, shape = 21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
plocorank03 <- ggplot(dlmLOCO, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
prf2err <- ggplot(drf2PFI, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) + 
  geom_point(fill = "white",size = 0, shape = 21 , 
             stroke= 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
prfrank04 <- ggplot(drf2PFI, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size=  2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
psvm2err <- ggplot(dsvm2PFI, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) + 
  geom_point(fill = "white",size = 0, shape = 21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
psvmrank05 <- ggplot(dsvm2PFI, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
plm2err <- ggplot(dlm2PFI, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) + 
  geom_point(fill = "white", size = 0, shape = 21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
plmrank06 <- ggplot(dlm2PFI, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
ploco2err <- ggplot(drf2LOCO, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) + 
  geom_point(fill = "white", size = 0, shape = 21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
plocorank04 <- ggplot(drf2LOCO, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
plocosvm2err <- ggplot(dsvm2LOCO, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp))+   geom_point(fill = "white", size = 0, shape = 21 , 
             stroke= 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
  scale_color_manual(values = c("0" = "skyblue", "0.25" = "royalblue", "0.5" = "blue",
...
plocorank05 <- ggplot(dsvm2LOCO, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
plocolm2err <- ggplot(dlm2LOCO, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) +
  geom_point(fill = "white",size = 0, shape = 21 , 
             stroke= 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
plocorank06 <- ggplot(dlm2LOCO, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
```{r bmr04, echo=FALSE, out.width = "100%", fig.cap = "Benchmark results of scenario 3 for data sets with p = 0, p = 0.5 and p = 0.99 (from left to right). On top the performance measure is the MSE, at the bottom $R^2$. The color representing the learning algorithm. Red: Random Forest, green: SVM and blue: Linear Model. ", fig.align = "center"}
...
prf3err <- ggplot(drf3PFI, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) + 
  geom_point(fill = "white",size=0, shape=21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
prfrank07 <- ggplot(drf3PFI, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group=features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
psvm3err <- ggplot(dsvm3PFI, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) + 
  geom_point(fill = "white", size = 0, shape = 21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
psvmrank08 <- ggplot(dsvm3PFI, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group=features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
plm3err <- ggplot(dlm3PFI, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) + 
  geom_point(fill = "white",size = 0, shape = 21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width  =0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
plmrank09 <- ggplot(dlm3PFI, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group=features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
ploco3err <- ggplot(drf3LOCO, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) + 
  geom_point(fill = "white", size = 0, shape = 21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
plocorank07 <- ggplot(drf3LOCO, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group=features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
plocosvm3err <- ggplot(dsvm3LOCO, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax=maximp))+    geom_point(fill = "white", size = 0, shape = 21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
  scale_color_manual(values = c("0" = "skyblue", "0.25" = "royalblue", "0.5" = "blue",
...
plocorank08 <- ggplot(dsvm3LOCO, aes(x=averagerank , y=Corr, color = features, group= features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
plocolm3err <- ggplot(dlm3LOCO, aes(x = features, y = importance, color = Corr, ymin = minimp, ymax = maximp)) +
  geom_point(fill = "white",size = 0, shape = 21 , 
             stroke = 2.5, show.legend = TRUE, position = position_dodge(width = 0.7)) +
  geom_errorbar(width = 0.5, size = 1, position = position_dodge(width = 0.7)) + 
  coord_flip() +
...
plocorank09 <- ggplot(dlm3LOCO, aes(x = averagerank , y = Corr, color = features, group = features)) +
  geom_point(size = 2)+
  geom_path(aes(group = features), size = 1)+
  coord_flip() +
  scale_color_manual(values = c("Uninf" = "#999999", "X1" = "darkred", "X2" = "red",
...
```{r bmrBoston,  eval = TRUE, echo = FALSE, out.width = "100%", fig.cap = "On the left-hand side the benchmark result for the random forest (red), the SVM (green) and the linear model (blue) on the basis of the Boston data set. The underlying performance measure is the MSE. On the right-hand side a Pearson correlation plot with the features of the Boston data set."}
...
we used the mlr package [@R-mlr] as well as the iml package [@molnar2018iml]. All plots have been created using ggplot2 [@R-ggplot2].
