...
```{r arrange19, message = FALSE, echo = FALSE, fig.height=6, fig.width=10, fig.cap= "PFI with different correlations of features 1 and 2 on SVM"}
library(ggpubr)
...
By duplicating the feature “lstat” and repeating PFI, one can see that ${dup\_lstat}$ and ${lstat}$ are equally important. They share as a rule of thumb the PFI of $\em{lstat}$ in the non-duplicating case (before: ${lstat}$ = 4.79 after: ${dup\_lstat}$ = 2.42 ${lstat}$ = 2.39)
