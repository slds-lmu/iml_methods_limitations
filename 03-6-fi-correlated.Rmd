...
Figure \@ref(fig:arrange01) shows the result of applying the PFI on the random forest model. 
...
psvmrank01 <- ggplot(drfPFI, aes(x=averagerank , y=Corr, colour = features, group= features)) +
  geom_point()+
...
library(ggpubr)
ggarrange(psvmerr, psvmrank01 , ncol=2, legend = "bottom")
