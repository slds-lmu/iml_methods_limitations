...
\begin{figure}
\includegraphics[width=0.9\linewidth]{images/age_pdp} \caption{The PDP shows that the survival probability is sharply dropping until age 18 and more moderately afterwards.}(\#fig:unnamed-chunk-1)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{images/pdp_class} \caption{The classification PDP reveals that passengers in lower classes had a lower probability to survive than those in a higher class.}(\#fig:unnamed-chunk-2)
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/pdp_2_features_1} \caption{The two-dimensional PDP for the numerical feature Age and the categorical feature Sex shows that while the survival probability for both genders declines as age increases, that there is a difference between genders an that the decrease is much steeper for males.}(\#fig:unnamed-chunk-3)
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{images/pdp_2_features_2} \caption{The two-dimensional PDP for the numerical features Age and Fare illustrates that survival probability of younger passengers is fairly uniform, whilke from age 20 onwards, passengers travelling at a lower fare also had a much lower probability to survive than those that paid a high fare.}(\#fig:unnamed-chunk-4)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{images/ice_plot} \caption{The ICE plot indicates that there is underlying heterogeneity in the complement set.}(\#fig:unnamed-chunk-5)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{images/c_ice_plot} \caption{Centered ICE plot.}(\#fig:unnamed-chunk-6)
\end{figure}
...
\begin{figure}
\includegraphics[width=13.75in]{images/ale_estimation_intuition} \caption{(ref:aleIntuition)}(\#fig:dataALE)
\end{figure}
...
\begin{figure}
\includegraphics[width=13.75in]{images/ale_example} \caption{(ref:aleExample)}(\#fig:aleEx)
\end{figure}
...
\caption{Example for Permutation Feature Importance}(\#fig:PFI)
\end{figure}
...
<center>
![(\#fig:plot)Visualization of Permutation Feature Importance with a random forest applied on Boston dataset](book_files/figure-latex/plot-1.pdf) 
...
\caption{Example for Leave-One-Covariate-Out Feature Importance}(\#fig:LOCO)
\end{figure}
...
\caption{Simplified graphical representaion of the LIME algorithm. Each single panel represents one step of the described algorithm. It reads from left to right.}(\#fig:unnamed-chunk-9)
\end{figure}
...
{\centering \includegraphics[width=0.99\linewidth]{book_files/figure-latex/unnamed-chunk-10-1} 

}

\caption{Basic example of a LIME application. We create a black box model on the iris dataset without the first data point and then explain the prediction of this point with LIME.}(\#fig:unnamed-chunk-10)
\end{figure}
...
\caption{Simulated data: Non-linear univariate relationship.}(\#fig:unnamed-chunk-11)
\end{figure}
...
\caption{Simulated data: Random Forest Predictions.}(\#fig:unnamed-chunk-12)
\end{figure}
...
\caption{Simulated data: Non-linear univariate relationship linearly interpolated.}(\#fig:unnamed-chunk-13)
\end{figure}
...
\caption{Simulated data: Local models for univariately non-linear data.}(\#fig:unnamed-chunk-14)
\end{figure}
...
{\centering \includegraphics[width=0.99\linewidth]{images/04-09-05-1} 

}

\caption{Simulated data: Local models for univariately non-linear data with different kernel sizes.}(\#fig:unnamed-chunk-15)
\end{figure}
...
\caption{Simulated data: Local models for univariately non-linear data with different kernel sizes.}(\#fig:unnamed-chunk-16)
\end{figure}
...
{\centering \includegraphics[width=0.99\linewidth]{images/04-09-07} 

}

\caption{Simulated data: Model evaluation for random forest.}(\#fig:unnamed-chunk-17)
\end{figure}
...
{\centering \includegraphics[width=13.89in]{images/04-09-08-1} 

}

\caption{Simulated data: Coefficients for different kernel widhts.}(\#fig:unnamed-chunk-18)
\end{figure}
\begin{figure}

{\centering \includegraphics[width=13.89in]{images/04-09-08-2} 
...
{\centering \includegraphics[width=13.89in]{images/04-09-08-3} 
...
{\centering \includegraphics[width=13.89in]{images/04-09-08-4} 
...
LIME should be able to detect this as well -- given an appropriate kernel.
